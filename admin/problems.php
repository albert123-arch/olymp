...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <a class="btn btn-primary" href="<?= h(url('admin/problem-edit.php')) ?>"><?= h(t('create')) ?></a>
</div>
...
<?php foreach ($rows as $row): ?>
  <tr>
    ...
    <td><a class="btn btn-sm btn-outline-primary" href="<?= h(url('admin/problem-edit.php', ['id' => $row['id']])) ?>"><?= h(t('edit')) ?></a></td>
  </tr>
<?php endforeach; ?>
</tbody></table></div>
<?php endif; ?>
