...
36=18\\cdot2+0.
\\]</p>
<p>Значит, \\(\\gcd(252,198)=18\\).</p>
<h3>6. Линейное представление НОД</h3>
<p>Если пройти алгоритм Евклида назад, НОД можно представить как линейную комбинацию:</p>
<p>\\[
\\gcd(a,b)=ax+by
\\]</p>
<p>для некоторых целых \\(x\\) и \\(y\\). Это называется тождеством Безу. Позже оно понадобится в диофантовых уравнениях и сравнениях.</p>', '<p>\\(84=2^2\\cdot3\\cdot7\\), \\(126=2\\cdot3^2\\cdot7\\), значит \\(\\gcd(84,126)=42\\).</p>
<ol>
<li>Найдите \\(\\gcd(84,126)\\).</li>
</ol>
<p>Берем максимальные показатели: \\(2^2\\cdot3^2\\cdot7=252\\).</p>
<ol>
<li>Найдите \\(\\operatorname{lcm}(84,126)\\).</li>
</ol>
<p>\\(252=198+54\\), \\(198=3\\cdot54+36\\), \\(54=36+18\\), \\(36=2\\cdot18\\). НОД равен \\(18\\).</p>
<ol>
<li>Найдите \\(\\gcd(252,198)\\) алгоритмом Евклида.</li>
</ol>
<p>\\(\\gcd(48,180)=12\\), поэтому \\(\\operatorname{lcm}(48,180)=48\\cdot180/12=720\\).</p>
<ol>
<li>Найдите \\(\\operatorname{lcm}(48,180)\\).</li>
</ol>
<p>Любой общий делитель делит разность \\((n+1)-n=1\\), значит НОД равен \\(1\\).</p>
<ol>
<li>Докажите, что \\(\\gcd(n,n+1)=1\\).</li>
</ol>
<p>Любой общий делитель делит разность \\(2\\), значит он является положительным делителем \\(2\\).</p>
<ol>
<li>Докажите, что \\(\\gcd(n,n+2)\\) равен \\(1\\) или \\(2\\).</li>
</ol>
...
<ol>
<li>Если \\(\\gcd(a,b)=1\\), найдите \\(\\gcd(a,ab+b)\\).</li>
</ol>
<p>\\(\\gcd(2026,2024)=\\gcd(2024,2)=2\\).</p>
<ol>
<li>Найдите \\(\\gcd(2026,2024)\\).</li>
</ol>
<p>Так как \\(d\\mid a\\) и \\(d\\mid b\\), число \\(d\\) делит любую целую линейную комбинацию.</p>
<ol>
<li>Докажите: если \\(d=\\gcd(a,b)\\), то \\(d\\mid ax+by\\) для любых целых \\(x,y\\).</li>
</ol>', '<ol>
<li>Перечислите все общие положительные делители чисел \\(24\\) и \\(36\\). Найдите \\(\\gcd(24,36)\\).</li>
<li>Найдите \\(\\operatorname{lcm}(8,12)\\), выписав положительные кратные.</li>
<li>Найдите \\(\\gcd(72,120)\\), используя разложение на простые множители.</li>
<li>Найдите \\(\\operatorname{lcm}(72,120)\\), используя разложение на простые множители.</li>
<li>Проверьте \\(ab=\\gcd(a,b)\\operatorname{lcm}(a,b)\\) для \\(a=72\\), \\(b=120\\).</li>
<li>Используйте алгоритм Евклида, чтобы найти \\(\\gcd(252,198)\\).</li>
<li>Найдите \\(\\gcd(1001,429)\\).</li>
<li>Докажите, что \\(\\gcd(n,n+1)=1\\).</li>
<li>Докажите, что \\(\\gcd(n,n+2)\\) равно либо \\(1\\), либо \\(2\\).</li>
<li>Если \\(\\gcd(a,b)=18\\) и \\(ab=9720\\), найдите \\(\\operatorname{lcm}(a,b)\\).</li>
<li>Если \\(\\gcd(a,b)=1\\), докажите, что \\(\\operatorname{lcm}(a,b)=ab\\).</li>
<li>Найдите целые \\(x,y\\), такие что \\(30x+18y=6\\).</li>
<li>Найдите \\(\\gcd(2026,2025)\\).</li>
<li>Используйте алгоритм Евклида, чтобы найти \\(\\gcd(987,610)\\).</li>
<li>Докажите, что \\(\\gcd(2n+1,4n+3)=1\\).</li>
<li>Докажите, что \\(\\gcd(n+3,n+9)\\) обязательно делит \\(6\\).</li>
...
<li>Пусть \\(d=\\gcd(a,b)\\). Докажите, что \\(d\\mid 7a-5b\\).</li>
<li>Найдите все возможные значения \\(\\gcd(n^2+n+1,n+1)\\).</li>
</ol>', '<h3>Цели урока</h3>
<ul>
<li>Ученики умеют определять \\(\\gcd(a,b)\\) и \\(\\operatorname{lcm}(a,b)\\).</li>
<li>Ученики умеют находить НОД и НОК через разложение на простые множители.</li>
<li>Ученики используют формулу \\(ab=\\gcd(a,b)\\operatorname{lcm}(a,b)\\).</li>
...
<li>Не замечают, что \\(\\gcd(n,n+1)=1\\) следует из разности \\(1\\).</li>
<li>Считают, что \\(\\operatorname{lcm}(a,b)=ab\\) всегда, хотя это гарантировано при \\(\\gcd(a,b)=1\\).</li>
</ul>
...
<li>Дать задачи с выражениями, например \\(\\gcd(2n+1,4n+3)\\).</li>
<li>Завершить одной олимпиадной разминкой.</li>
</ol>
<h3>Дополнительные вопросы</h3>
<ul>
<li>Найдите все возможные значения \\(\\gcd(n+4,n+10)\\).</li>
<li>Докажите, что \\(\\gcd(3n+2,5n+3)\\) делит \\(1\\).</li>
<li>Найдите целые \\(x,y\\), такие что \\(99x+78y=\\gcd(99,78)\\).</li>
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Общие делители', '<p>Перечислите все общие положительные делители чисел \\(24\\) и \\(36\\), затем найдите \\(\\gcd(24,36)\\).</p>', '<p>Сначала выпишите делители каждого числа и сравните два списка.</p>', '<p>Положительные делители \\(24\\): \\(1,2,3,4,6,8,12,24\\). Положительные делители \\(36\\): \\(1,2,3,4,6,9,12,18,36\\). Общие делители: \\(1,2,3,4,6,12\\), значит \\(\\gcd(24,36)=12\\).</p>', '<p>Используйте эту задачу как медленный первый пример, чтобы смысл НОД стал конкретным.</p>');
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Первый НОК', '<p>Найдите \\(\\operatorname{lcm}(8,12)\\), выписав положительные кратные.</p>', '<p>Выпишите несколько кратных \\(8\\) и несколько кратных \\(12\\). Найдите первое общее.</p>', '<p>Кратные \\(8\\): \\(8,16,24,32,\\ldots\\). Кратные \\(12\\): \\(12,24,36,\\ldots\\). Первое общее положительное кратное равно \\(24\\), поэтому \\(\\operatorname{lcm}(8,12)=24\\).</p>', '<p>Сравните идею наибольшего общего делителя и наименьшего общего кратного.</p>');
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'НОД через простые степени', '<p>Найдите \\(\\gcd(72,120)\\), используя разложение на простые множители.</p>', '<p>Берите меньший показатель степени у каждого простого числа.</p>', '<p>Имеем \\(72=2^3\\cdot3^2\\) и \\(120=2^3\\cdot3\\cdot5\\). Общие простые степени: \\(2^3\\) и \\(3^1\\), поэтому \\(\\gcd(72,120)=2^3\\cdot3=24\\).</p>', '<p>Попросите учеников проговорить: НОД означает минимальные показатели степеней.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'НОК через простые степени', '<p>Найдите \\(\\operatorname{lcm}(72,120)\\), используя разложение на простые множители.</p>', '<p>Берите больший показатель степени у каждого простого числа, которое встречается.</p>', '<p>Так как \\(72=2^3\\cdot3^2\\), а \\(120=2^3\\cdot3\\cdot5\\), получаем \\(\\operatorname{lcm}(72,120)=2^3\\cdot3^2\\cdot5=360\\).</p>', '<p>Дайте эту задачу сразу после предыдущей.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'lcm';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'prime-factorisation';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Проверка формулы произведения', '<p>Проверьте равенство \\(ab=\\gcd(a,b)\\operatorname{lcm}(a,b)\\) для \\(a=72\\), \\(b=120\\).</p>', '<p>Используйте ответы из двух предыдущих задач.</p>', '<p>Из предыдущих задач \\(\\gcd(72,120)=24\\) и \\(\\operatorname{lcm}(72,120)=360\\). Тогда \\(24\\cdot360=8640\\), и \\(72\\cdot120=8640\\). Равенство выполнено.</p>', '<p>Эта задача готовит формулу как вычислительный инструмент.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'lcm';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Алгоритм Евклида I', '<p>Используйте алгоритм Евклида, чтобы найти \\(\\gcd(252,198)\\).</p>', '<p>Начните с равенства \\(252=198\\cdot1+54\\).</p>', '<p>\\(252=198+54\\), \\(198=54\\cdot3+36\\), \\(54=36+18\\), \\(36=18\\cdot2+0\\). Последний ненулевой остаток равен \\(18\\), значит \\(\\gcd(252,198)=18\\).</p>', '<p>Подчеркните, что ответом является последний ненулевой остаток.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Алгоритм Евклида II', '<p>Найдите \\(\\gcd(1001,429)\\), используя алгоритм Евклида.</p>', '<p>Разделите \\(1001\\) на \\(429\\), затем продолжайте с остатком.</p>', '<p>\\(1001=429\\cdot2+143\\), а \\(429=143\\cdot3+0\\). Следовательно, \\(\\gcd(1001,429)=143\\).</p>', '<p>Короткий пример алгоритма Евклида помогает ученикам почувствовать уверенность.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'euclidean-algorithm';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Последовательные целые числа', '<p>Докажите, что \\(\\gcd(n,n+1)=1\\) для любого целого \\(n\\).</p>', '<p>Любой общий делитель должен делить разность чисел.</p>', '<p>Если \\(d\\mid n\\) и \\(d\\mid n+1\\), то \\(d\\mid (n+1)-n=1\\). Значит, \\(d=1\\), поэтому \\(\\gcd(n,n+1)=1\\).</p>', '<p>Это важная олимпиадная привычка: общие делители делят разности.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Числа через одно', '<p>Докажите, что \\(\\gcd(n,n+2)\\) равно либо \\(1\\), либо \\(2\\).</p>', '<p>Общий делитель чисел \\(n\\) и \\(n+2\\) делит \\((n+2)-n\\).</p>', '<p>Пусть \\(d=\\gcd(n,n+2)\\). Тогда \\(d\\mid n\\) и \\(d\\mid n+2\\), значит \\(d\\mid2\\). Поэтому \\(d\\in\\{1,2\\}\\).</p>', '<p>Спросите, когда возникает каждый случай: при нечетном \\(n\\) получаем \\(1\\), при четном \\(n\\) получаем \\(2\\).</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'proof';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Найти НОК через НОД', '<p>Если \\(\\gcd(a,b)=18\\) и \\(ab=9720\\), найдите \\(\\operatorname{lcm}(a,b)\\).</p>', '<p>Используйте формулу \\(ab=\\gcd(a,b)\\operatorname{lcm}(a,b)\\).</p>', '<p>Имеем \\(9720=18\\operatorname{lcm}(a,b)\\), поэтому \\(\\operatorname{lcm}(a,b)=9720/18=540\\).</p>', '<p>Это простой числовой пример применения формулы произведения.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'lcm';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'identity';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Произведение взаимно простых чисел', '<p>Если \\(\\gcd(a,b)=1\\), докажите, что \\(\\operatorname{lcm}(a,b)=ab\\).</p>', '<p>Используйте формулу \\(ab=\\gcd(a,b)\\operatorname{lcm}(a,b)\\).</p>', '<p>Так как \\(\\gcd(a,b)=1\\), формула дает \\(ab=1\\cdot\\operatorname{lcm}(a,b)\\). Следовательно, \\(\\operatorname{lcm}(a,b)=ab\\).</p>', '<p>Свяжите это с идеей отсутствия общих простых множителей.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'coprime';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'lcm';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'НОД больших соседних чисел', '<p>Найдите \\(\\gcd(2026,2025)\\).</p>', '<p>Эти числа отличаются на \\(1\\).</p>', '<p>Любой общий делитель делит \\(2026-2025=1\\). Поэтому \\(\\gcd(2026,2025)=1\\).</p>', '<p>Хорошее устное упражнение: длинные вычисления не нужны.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'difference';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'НОД выражений', '<p>Докажите, что \\(\\gcd(2n+1,4n+3)=1\\) для любого целого \\(n\\).</p>', '<p>Вычтите из второго выражения удвоенное первое.</p>', '<p>Пусть \\(d\\) делит и \\(2n+1\\), и \\(4n+3\\). Тогда \\(d\\mid (4n+3)-2(2n+1)=1\\). Значит, \\(d=1\\), поэтому НОД равен \\(1\\).</p>', '<p>Отличный мост от алгоритма Евклида к работе с выражениями.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'proof';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Возможный НОД', '<p>Докажите, что \\(\\gcd(n+3,n+9)\\) обязательно делит \\(6\\).</p>', '<p>Посмотрите на разность двух чисел.</p>', '<p>Если \\(d=\\gcd(n+3,n+9)\\), то \\(d\\mid n+3\\) и \\(d\\mid n+9\\). Следовательно, \\(d\\mid (n+9)-(n+3)=6\\).</p>', '<p>Спросите учеников, какие делители \\(6\\) действительно могут получиться.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'proof';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'difference';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Текстовая задача на НОК', '<p>Два звонка звучат каждые \\(12\\) минут и каждые \\(18\\) минут. Если сейчас они прозвучали вместе, через сколько минут они снова прозвучат вместе?</p>', '<p>Здесь нужно найти наименьшее общее кратное чисел \\(12\\) и \\(18\\).</p>', '<p>Следующее общее время - это \\(\\operatorname{lcm}(12,18)\\). Так как \\(12=2^2\\cdot3\\), а \\(18=2\\cdot3^2\\), НОК равен \\(2^2\\cdot3^2=36\\). Звонки прозвучат вместе через \\(36\\) минут.</p>', '<p>Используйте задачу, чтобы отличать ситуации на НОК от ситуаций на НОД.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'lcm';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Общий делитель линейной комбинации', '<p>Пусть \\(d=\\gcd(a,b)\\). Докажите, что \\(d\\mid 7a-5b\\).</p>', '<p>Так как \\(d\\mid a\\) и \\(d\\mid b\\), число \\(d\\) делит целые комбинации \\(a\\) и \\(b\\).</p>', '<p>Так как \\(d=\\gcd(a,b)\\), имеем \\(d\\mid a\\) и \\(d\\mid b\\). Значит, \\(d\\mid 7a\\) и \\(d\\mid 5b\\), поэтому \\(d\\mid 7a-5b\\).</p>', '<p>Этот шаблон доказательства снова появится в модульной арифметике.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'linear-combination';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'proof';
...
INSERT INTO problem_texts (problem_id, lang, title, statement_html, hint_html, solution_html, teacher_note_html) VALUES
(@problem_id, 'ru', 'Олимпиадная разминка', '<p>Найдите все возможные значения \\(\\gcd(n^2+n+1,n+1)\\), когда \\(n\\) пробегает целые числа.</p>', '<p>Упростите \\(n^2+n+1\\) по модулю \\(n+1\\). Если \\(n\\equiv -1\\pmod{n+1}\\), что остается?</p>', '<p>Пусть \\(d=\\gcd(n^2+n+1,n+1)\\). Так как \\(n\\equiv -1\\pmod{n+1}\\), получаем \\(n^2+n+1\\equiv 1-1+1=1\\pmod{n+1}\\). Значит, любой общий делитель делит \\(1\\), поэтому единственное возможное значение - \\(1\\).</p>', '<p>Это короткий предварительный взгляд на мышление через сравнения без полноценного урока по модульной арифметике.</p>');
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'gcd';
INSERT IGNORE INTO problem_tags (problem_id, tag_id) SELECT @problem_id, id FROM tags WHERE slug = 'proof';
