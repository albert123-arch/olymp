...
<div class="mb-4">
    ...
    <div class="text-muted math-content"><?= math_html($chapter['description_html'] ?? '') ?></div>
</div>
...
<div class="tab-content">
    <section class="tab-pane fade show active admin-panel p-3 math-content" id="theory"><?= math_html($chapter['theory_html'] ?? e(t('coming_soon'))) ?></section>
    <section class="tab-pane fade admin-panel p-3 math-content" id="examples"><?= math_html($chapter['examples_html'] ?? e(t('coming_soon'))) ?></section>
    ...
    <section class="tab-pane fade admin-panel p-3 math-content" id="worksheet"><?= math_html($chapter['worksheet_html'] ?? e(t('coming_soon'))) ?></section>
    <?php if (is_teacher()): ?><section class="tab-pane fade admin-panel p-3 math-content" id="teacher"><?= math_html($chapter['teacher_notes_html'] ?? e(t('teacher_only'))) ?></section><?php endif; ?>
</div>
