...
If the database was created from the older export, run this upgrade migration to keep existing users, problems, and translations:

```bash
mysql -u USER -p DATABASE < database/upgrade_legacy_to_new.sql
```
